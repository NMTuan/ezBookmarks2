 ...
 * @LastEditTime: 2022-11-02 16:36:21
 * @LastEditors: NMTuan
 * @Description: 
 * @FilePath: \ezBookmarks2\src\content-scripts\App.vue
-->
<template>
  <div class="ez fixed inset-0 w-full h-full bg-black bg-opacity-10 z-50" v-show="visible">
    <div class="ez absolute top-4 right-4 bg-white shadow-lg p-4 rounded-md w-72">
